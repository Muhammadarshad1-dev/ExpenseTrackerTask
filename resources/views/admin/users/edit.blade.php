                                            ...
                                            @foreach ($allUsers as $key => $allUser)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('users.edit',$allUser->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="UserformUpdate" id="UserformUpdate" method="post">
                                <div class="row">
                                     <input type="hidden" name="ueid" value="{{$edits->id}}">
                                    <div class="col-md-12">
                                        <div class="mb-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email"
                                                 autocomplete="off" value="{{$edits->email}}">
                                            <span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-6">
                                            ...
                                            <select class="form-select" id="designation" name="designation">
                                                @if($edits->designation)
                                                    @foreach ($desginations as $desgination)
                                                        <option {{$edits->designation->id == $desgination->id ? 'selected' : '' }} value="{{ $desgination->id }}">{{ $desgination->name }}</option>
                                                    @endforeach
                                                @else
